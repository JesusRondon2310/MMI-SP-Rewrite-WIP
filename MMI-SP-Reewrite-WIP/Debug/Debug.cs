    ...
    public static class Debug
    {
        ...
        public static void ShowVehicleInfo(Vehicle veh)
        {
            ...
            if (veh != null)
            {
                ...
                debugTextVehInsured.Caption = "Insured: " + Manager.Instance.IsVehicleInsured(veh).ToString();
                debugTextVehInsured.Draw();
                debugTextVehPrice.Caption = "Price: " + Manager.Instance.GetVehicleInsuranceCost(veh).ToString();
